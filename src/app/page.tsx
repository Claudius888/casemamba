      ...
      <section>
        <MaxwidthWrapper
          className='pb-24 pt-10 lg:grid-cols-3 sm:pb-32 
              lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lt:pb-52'
        >
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            ...
            >
              ...
              <h1
                className='relative w-fit tracking-tight 
              text-balance mt-16 font-boldF !leading-tight
              ...
              >
                ...
                CaseMamba allows your to protect your memories, not just your
                phone case.
              </p>
              <ul
          ...
          sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 
          h-fit'
          >
